...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/community/post/:id/quotes', component: () => import('./community/CommunityCollectionView.vue'), meta: { title: '学习话题', communityView: 'quotes', requiresAuth: true, layout: 'community', communityMode: 'feed' } },
    ...
    { path: '/community/people/:userId', component: () => import('./community/CommunityProfileView.vue'), meta: { title: '社区主页', requiresAuth: true, layout: 'community', communityMode: 'feed' } },
