...
{ path: '/study-ranking/school/:schoolId', name: 'study-ranking-school', component: () => import('./views/StudyRankingView.vue'), meta: { title: '校内学时排名', layout: 'adaptive', requiresAuth: true, communityMode: 'wide' } },
