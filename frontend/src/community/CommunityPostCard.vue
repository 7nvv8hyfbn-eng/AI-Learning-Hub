...
import { assistantState, requestAssistantDigest } from '../assistant/assistantState'
...
const digestEnabled = computed(() => assistantState.ready && assistantState.config.enabled && assistantState.config.digestEnabled)
const openDigest = () => { void requestAssistantDigest(props.post.id, props.post.title || '') }
