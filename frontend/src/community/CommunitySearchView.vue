...
const load = async (more = false) => {
  ...
  try {
    ...
    result.value = next
    store.syncAuthors([...next.users, ...next.posts.map(post => post.author)])
