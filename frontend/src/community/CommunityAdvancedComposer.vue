...
const keydown = (event: KeyboardEvent) => {
 ...
 if ((event.ctrlKey || event.metaKey) && event.key === 'Enter') { event.preventDefault(); void editor.save() }; if (event.key === 'Escape') { event.stopPropagation(); editor.close() } }
